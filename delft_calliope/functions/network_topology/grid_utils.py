...
This module provides utility functions for distance calculations and
line interpolation used in network topology processing.
"""
...
def interpolate_line(lat1, lon1, lat2, lon2, spacing_m):
    ...
    ----------
    lat1, lon1 : float
        Latitude and longitude of start point in degrees
    lat2, lon2 : float
        Latitude and longitude of end point in degrees
    spacing_m : float
        Desired spacing between interpolated points in meters
    
    Returns
    -------
    list of tuples
        List of (latitude, longitude) tuples for interpolated points,
