"""
Building Processing Module

This module processes BAG building data and creates DataFrames with
geometry, addresses, and metadata, with optional visualization.
"""
...
def process_and_visualize_buildings(all_buildings, building_addresses, mode='plot', debug_folder='debug'):
    ...
    ----------
    all_buildings : list
        List of building dictionaries from BAG API.
    building_addresses : dict
        Dictionary mapping building IDs to address information.
    mode : str
        If 'plot', creates an interactive map visualization. Default is 'plot'.
    debug_folder : str
    ...
    -------
    pd.DataFrame
        DataFrame containing building information with geometry, addresses, and metadata.
    """
