"""
Scenario Summary Export Module

This module handles saving comprehensive scenario summaries to JSON files,
including configuration, model results, execution times, and loss calculations.
"""
...
def save_scenario_summary(config, model, results_df, output_folder='outputs',
                          ...
                          total_LQ_losses_kw=0.0, total_HQ_losses_kw=0.0,
    ...
    total_LQ_losses_kw : float, optional
        Total LQ network losses in kW (default: 0.0)
    total_HQ_losses_kw : float, optional
        Total HQ network losses in kW (default: 0.0)
    substation_efficiency_losses_kw : float, optional
        Substation efficiency losses in kW (default: 0.0)
    ...
    -------
    dict
        The scenario summary dictionary that was saved
    """
